...
function img() {
    return src(`${sourse}/img/*.{jpg,png}`)
        .pipe(sharpResponsive({
            formats: [
                // 2x
                { pngOptions: { quality: 100, progressive: true }, rename: { dirname: path2 } },
                { jpegOptions: { quality: 100, progressive: true }, rename: { dirname: path2 } },
                ...
                // 1x
                { width: w50, pngOptions: { quality: 100, progressive: true }, rename: { dirname: path1 } },
                { width: w50, jpegOptions: { quality: 100, progressive: true }, rename: { dirname: path1 } },
